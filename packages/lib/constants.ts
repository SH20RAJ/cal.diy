...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://creatorcall.app";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "CreatorCall";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@creatorcall.app";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "CreatorCall";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "CreatorCall";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "CreatorCall";
...
export const LOGO = "/creatorcall-logo-word-light.svg";
export const LOGO_DARK = "/creatorcall-logo-word-dark.svg";
export const LOGO_ICON = "/creatorcall-logo-icon.svg";
